...
class DQNSolver:
    def __init__(self, observation_space, action_space):
        ...
        #Responsible for the memory of the learning
        ...
        #responsible to make the algorithm remember what learned
        def remember(self, state, action, reward, next_state, done):
            self.memory.append((state, action, reward, next_state, done))

        #responsible to make the decisions, randomly at the beggining
        def act(self, state):
